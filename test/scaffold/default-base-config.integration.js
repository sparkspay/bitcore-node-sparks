...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    sparksd.spawn.datadir.should.equal(home + '/.sparks');
    sparksd.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.sparks/sparksd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.sparksd.spawn.datadir.should.equal('./data2');
  });
});
